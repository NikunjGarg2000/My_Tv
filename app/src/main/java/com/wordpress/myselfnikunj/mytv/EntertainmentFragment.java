...
public class EntertainmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("channels").child("Category").child("Entertainment");
    ...
    public void fetchDataForHindi() {
        databaseReference.child("Hindi_Entertainment").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void fetchDataForMarathi() {
            databaseReference.child("Marathi_Entertainment").addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    for (DataSnapshot snapshot:dataSnapshot.getChildren()) {
                        LiveChannelModel model = snapshot.getValue(LiveChannelModel.class);
