...
public class InfotainmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_infotainment, container, false);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("channels").child("Category").child("Infotainment");
    ...
    public void fetchDataForHindi() {
        databaseReference.child("Hindi_Infotainment").addValueEventListener(new ValueEventListener() {
            @Override
