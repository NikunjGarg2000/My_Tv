...
public class NewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("channels").child("Category").child("News");
    ...
    public void fetchDataForEnglish() {
        databaseReference.child("English_News").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void fetchDataForHindi() {
        databaseReference.child("Hindi_News").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    LiveChannelModel model = snapshot.getValue(LiveChannelModel.class);
    ...
    public void fetchDataForMarathi() {
        databaseReference.child("Marathi_News").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot:dataSnapshot.getChildren()) {
                    LiveChannelModel model = snapshot.getValue(LiveChannelModel.class);
